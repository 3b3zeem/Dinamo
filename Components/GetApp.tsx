...
const GetApp = () => {
  return (
    <section className="flex items-center justify-center w-full flex-col pb-[100px]">
      <div className="mx-auto 2xl:max-w-[1440px] xl:max-w-[1300px] relative flex w-full flex-col justify-between gap-32 overflow-hidden bg-[url('/pattern.png')] bg-cover bg-center bg-no-repeat px-6 py-12 text-white sm:flex-row sm:gap-12 sm:py-24 lg:px-20 xl:max-h-[598px] xl:rounded-[40px]">
